...
function startSession() {
    ...
    // Owner mode: message_create fires for ALL messages including self-sent.
    // When owner opens WhatsApp Saved Messages (texts own number),
    // msg.fromMe=true AND msg.from===msg.to. Normal message event blocks fromMe.
